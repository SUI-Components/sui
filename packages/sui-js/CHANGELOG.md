...
* add highlightText method to sui-js ([05157ac](https://github.com/SUI-Components/sui/commit/05157ac))
* add readme (bump bersion) ([20e7132](https://github.com/SUI-Components/sui/commit/20e7132))
* extract tags length into a variable ([25ed87c](https://github.com/SUI-Components/sui/commit/25ed87c))
...
* add encode property to toQueryString options handling and call to stringify ([8b9f01f](https://github.com/SUI-Components/sui/commit/8b9f01f))
...
* enable delimiter to toQueryString method ([3e5ddbe](https://github.com/SUI-Components/sui/commit/3e5ddbe))
...
* Prefer just libraries instead lodash and others ([59183c2](https://github.com/SUI-Components/sui/commit/59183c2))
...
* add delimiter option ([a454490](https://github.com/SUI-Components/sui/commit/a454490))
...
* add options to parseQueryString ([b36f6a4](https://github.com/SUI-Components/sui/commit/b36f6a4))
* add own toQueryString ([b9956b3](https://github.com/SUI-Components/sui/commit/b9956b3))
* add second param for options ([a84ac13](https://github.com/SUI-Components/sui/commit/a84ac13))
...
* remove only method ([32d0f23](https://github.com/SUI-Components/sui/commit/32d0f23))


### Features

* add specs ([de30f4c](https://github.com/SUI-Components/sui/commit/de30f4c))
* add support for managing cookies without encoding ([9298dbe](https://github.com/SUI-Components/sui/commit/9298dbe))
...
* fix the md5 url reference ([9538177](https://github.com/SUI-Components/sui/commit/9538177))
...
* arrayToCommaQueryString method ([80f69a0](https://github.com/SUI-Components/sui/commit/80f69a0))
* fix deprecated unescape to decodeUriComponent ([7eea020](https://github.com/SUI-Components/sui/commit/7eea020))
* fix example response ([8dfc7a1](https://github.com/SUI-Components/sui/commit/8dfc7a1))
* fix test description method name ([3e8e417](https://github.com/SUI-Components/sui/commit/3e8e417))
* fix unescape ([03c8ba2](https://github.com/SUI-Components/sui/commit/03c8ba2))
* rename method ([4c57be6](https://github.com/SUI-Components/sui/commit/4c57be6))
...
* move htmr to React context ([75df8c7](https://github.com/SUI-Components/sui/commit/75df8c7))
...
* fix export name for htmr ([830a308](https://github.com/SUI-Components/sui/commit/830a308))
...
* added htmr package ([f6c424b](https://github.com/SUI-Components/sui/commit/f6c424b))
