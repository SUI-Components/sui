export default {
  Chrome: [
    ...
    {
      ua: 'Mozilla/5.0 (Linux; Android 4.3; Galaxy Nexus Build/JWR66Y) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/32.0.1700.99 Mobile Safari/537.36',
      spec: {
        browser: {
          name: 'Chrome',
          version: '32.0.1700.99'
    ...
    {
      ua: 'Mozilla/5.0 (Linux; Android 6.0.99; Build/NPC91K) AppleWebKit/537.36(KHTML, like Gecko) Chrome/50.0.2661.86 Safari/537.36',
      spec: {
        browser: {
          name: 'Chrome',
  ...
  Opera: [
    {
      ua: 'Mozilla/5.0 (Linux; Android 4.4.2; Nexus 7 Build/KOT49H) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/32.0.1700.72 Safari/537.36 OPR/19.0.1340.69721',
      spec: {
        browser: {
          name: 'Opera',
    ...
    {
      ua: 'Mozilla/5.0 (Linux; Android 4.3; Galaxy Nexus Build/JWR66Y) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/32.0.1700.72 Mobile Safari/537.36 OPR/19.0.1340.69721',
      spec: {
        browser: {
          name: 'Opera',
          version: '19.0.1340.69721'
    ...
    {
      ua: 'Mozilla/5.0 (Linux; U; Android 6.0; R1 HD Build/MRA58K; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/52.0.2743.98 Mobile Safari/537.36 OPR/18.0.2254.106542',
      spec: {
        browser: {
          name: 'Opera',
  ...
  'Microsoft Edge': [
    ...
    {
      ua: 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3739.0 Safari/537.36 Edg/75.0.109.0',
      spec: {
        browser: {
          name: 'Microsoft Edge',
          version: '75.0.109.0'
