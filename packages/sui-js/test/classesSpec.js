...
describe('@s-ui/js', () => {
  describe('classes:suitClass', () => {
    it('should create a valid class name with children following convention', () => {
      ...
      expect(childrenComponent({element: 'element', modifier: 'modifier'})).to.be.equal(
        'baseComponent-childrenComponent-element--modifier'
      )
    })

    it('should create a valid class name without children following convention', () => {
      const baseComponent = suitClass('baseComponent')()
      expect(baseComponent({element: 'element', modifier: 'modifier'})).to.be.equal('baseComponent-element--modifier')
    })
    ...
    it('should create a valid class name with element', () => {
      const baseComponent = suitClass('baseComponent')()
      expect(baseComponent({element: 'element'})).to.be.equal('baseComponent-element')
    })
  })
})
