...
describe.only('test sass-loader', function() {
  ...
  it.skip('should load sass file with data option', function(done) {
  ...
  it.skip('should compile without options', function(done) {
    runSimpleTest(done, 'simple')
  })

  it.skip('should auto remove BOM header', function(done) {
    runSimpleTest(done, 'bom-issue')
  })

  it.skip('should resolve files with double extensions', function(done) {
    runSimpleTest(done, 'double-extensions')
  })

  it.skip('should be able to import non sass files with a passed transformer', function(done) {
    runSimpleTest(done, 'withTransformer')
  })

  it.skip('should be able to skip import in comment', function(done) {
    runSimpleTest(done, 'comment-import')
  })

  it.skip('should be able to resolve @import paths (#39)', function(done) {
    runSimpleTest(done, 'data-import-issue')
  })

  it.skip('should pass options to sass.render (#53)', function(done) {
