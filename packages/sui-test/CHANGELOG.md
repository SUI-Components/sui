...
* export instead of exports ([3a27522](https://github.com/SUI-Components/sui/commit/3a27522))
...
* babel/register is using import/export and expecting webpack to be used ([0fae033](https://github.com/SUI-Components/sui/commit/0fae033))
...
* add inspect flag to server command ([aae232e](https://github.com/SUI-Components/sui/commit/aae232e))
...
* dont export CYPRESS_VERSION ([315ab70](https://github.com/SUI-Components/sui/commit/315ab70))
* export CYPRESS_VERSION like env var ([8ebfdbc](https://github.com/SUI-Components/sui/commit/8ebfdbc))


### Features

* Bump version ([06bc402](https://github.com/SUI-Components/sui/commit/06bc402))
...
* upgrade cypress to 3.2.0 version ([6104316](https://github.com/SUI-Components/sui/commit/6104316))
...
* npm install command add --save-dev flag ([47fc0b3](https://github.com/SUI-Components/sui/commit/47fc0b3))


### Features

* build a Docker image in each release ([11f0279](https://github.com/SUI-Components/sui/commit/11f0279))
* move cypressVersion to package.json ([46577c2](https://github.com/SUI-Components/sui/commit/46577c2))
