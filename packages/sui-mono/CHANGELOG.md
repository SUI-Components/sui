...
* program options are strings, force chunk as number before execute p-queue command ([2b0ebfe](https://github.com/SUI-Components/sui/commit/2b0ebfe))
...
* add needed scripts flag ([300830c](https://github.com/SUI-Components/sui/commit/300830c))
* remove bin-links flag that's breaking some deployments ([8822812](https://github.com/SUI-Components/sui/commit/8822812))


### Features

* add new --ci flag focused on ci installs with fixes and optimizations ([cc2252e](https://github.com/SUI-Components/sui/commit/cc2252e))
* dont show progress on ci ([abe55aa](https://github.com/SUI-Components/sui/commit/abe55aa))
* install execa dependency ([d8b83c4](https://github.com/SUI-Components/sui/commit/d8b83c4))
...
* add no-root option and better logging ([ccf8950](https://github.com/SUI-Components/sui/commit/ccf8950))
* avoid downloading gif asset ([3df84a9](https://github.com/SUI-Components/sui/commit/3df84a9))
* change message to be more semantically clear and Adria is happy with me ([1c5cf0e](https://github.com/SUI-Components/sui/commit/1c5cf0e))
* remove not needed dependency ([e0a6275](https://github.com/SUI-Components/sui/commit/e0a6275))
* show error message ([0f7834c](https://github.com/SUI-Components/sui/commit/0f7834c))
* simplify sui-mono phoenix ([2a085a3](https://github.com/SUI-Components/sui/commit/2a085a3))
* use a less problematic concurrency ([2214341](https://github.com/SUI-Components/sui/commit/2214341))
...
* upgrade dependencies to stop using spawn-sync sub-dependency ([61f4d15](https://github.com/SUI-Components/sui/commit/61f4d15))
...
* resolve promise after writing stream ends ([abbcc9e](https://github.com/SUI-Components/sui/commit/abbcc9e))
...
* fix getChangelogFilename import ([b4d08c3](https://github.com/SUI-Components/sui/commit/b4d08c3))


### Features

* add getter for changelog filename in config ([9c770a7](https://github.com/SUI-Components/sui/commit/9c770a7))
* get changelog file name from config ([5c404a5](https://github.com/SUI-Components/sui/commit/5c404a5))
* limit committed files to package.json and changelog.md ([88fd9dc](https://github.com/SUI-Components/sui/commit/88fd9dc))
